  ...
  return (
    <div className={`${align === "center" ? "items-center text-center" : "items-start text-left"} flex flex-col ${className}`}>
      <div className="flex items-center gap-2.5">
        ...
        <span className="font-display text-[1.85rem] font-black uppercase leading-none tracking-[0.06em] text-porcelain">
          Rebuild
        </span>
      </div>
      {showTagline ? (
        <div className="mt-1.5 flex items-center gap-2">
          ...
          <span className="font-display text-[0.62rem] font-black uppercase tracking-[0.35em] text-champagne">
            Better every day
          </span>
          <span className="h-px w-8 bg-champagne/70" aria-hidden />
        </div>
